			...
			<div id="main">
				...
				<div id="content">
					<div id="featured">
						...
						<p> • Designed, developed, and maintained software applications based on the product manager’s requirement and technical specifications.<br/>
						• Developed new algorithms to further improve existing features or new features..<br/>
						• Helped develop new features that integrate AI (Ex. ChatGPT) by participating in prompt engineering.<br/>
						• Wrote simple to more complex MYSQL queries to complement new features.<br/>
						• Followed the REST API design principle when updating or writing new public API endpoints. <br />
						• Promptly learned new technology to the point of being able to fully and efficiently help with migrating existing code base to the new technology and develop new features. <br />
						• Identified and thoroughly resolved bugs by collaborating with QA engineers to replicate issues, analyze root causes, and implement effective fixes. <br />
						• Developed and executed unit tests to ensure the quality and functionality of application. <br />
						• Monitored and optimized the performance of the application, addressing performance bottlenecks and
						improving system efficiency. <br />
						• Participated in code reviews to ensure high-quality deliverables. </p>
					</div>
